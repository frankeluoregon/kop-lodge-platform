...
import { e as createComponent, l as defineStyleVars, g as addAttribute, n as renderHead, r as renderTemplate, h as createAstro } from '../chunks/astro/server_BWLNsKza.mjs';
import { C as getAllLodges } from '../chunks/db_BboLBK6-.mjs';
/* empty css                                 */
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Oregon Knights of Pythias – Lodge Directory</title><meta name="description" content="Oregon Knights of Pythias — Lodge Directory. Friendship, Charity, Benevolence."><link rel="icon" type="image/svg+xml" href="/favicon.svg">${renderHead()}</head> <body data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> <header data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> <div class="header-inner" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> <a href="/"${addAttribute(`${"text-decoration:none"}; ${$$definedVars}`, "style")} class="brand-group" data-astro-cid-j7pv25f6> <img src="/seal.png" alt="KoP Seal" class="header-logo" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> <div data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> <div class="brand-name" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}>Oregon Knights of Pythias</div> <div class="brand-sub" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}>Grand Domain of Oregon &middot; Lodge Directory</div> <div class="motto" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}>Friendship &middot; Charity &middot; Benevolence</div> </div> </a> <nav${addAttribute(`${"display:flex;gap:.4rem;align-items:center;flex-wrap:wrap"}; ${$$definedVars}`, "style")} data-astro-cid-j7pv25f6> <a href="/" class="ext-link active" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}>Home</a> <a href="/grand-lodge/officers" class="ext-link" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}>Grand Officers</a> <a href="/grand-lodge/history" class="ext-link" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}>History</a> <a href="https://www.pythias.org" target="_blank" rel="noopener" class="ext-link" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}>Supreme Lodge ↗</a> </nav> </div> </header> <div class="hero" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> <img src="/hero.png" alt="Oregon Knights of Pythias — Friendship, Charity, Benevolence" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> </div> <main data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> <div class="content-box" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> <h2 class="section-heading" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}>
...
</p> </div> <div class="content-box" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}> <h2 class="section-heading" data-astro-cid-j7pv25f6${addAttribute($$definedVars, "style")}>
Oregon Lodges
